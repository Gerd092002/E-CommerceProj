...
if (!empty($search_query)) {
    $safeSearch = mysqli_real_escape_string($conn, $search_query);
    $whereClauses[] = "(p.product_name LIKE '%$safeSearch%' OR c.categoryName LIKE '%$safeSearch%' OR CAST(p.price AS CHAR) LIKE '%$safeSearch%')";
}
