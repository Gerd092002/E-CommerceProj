...
<div class="col-span-1 md:col-span-2">
    <div class="bg-white h-full rounded-2xl flex flex-col shadow-sm">
        ...
        <div class="flex flex-col gap-4 mt-4 items-center p-4">
            ...
            <a href="dashboard.php?content=cart" class="group hover:bg-blue-500 p-3 rounded-xl flex items-center w-full transition <?php echo (isset($_GET['content']) && $_GET['content'] === 'cart') ? 'bg-blue-500' : ''; ?>">
                <svg class="<?php echo (isset($_GET['content']) && $_GET['content'] === 'cart') ? 'text-white' : 'text-blue-500'; ?> group-hover:text-white transition" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="24" height="24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
                </svg>
                <h1 class="text-2xl ms-2 <?php echo (isset($_GET['content']) && $_GET['content'] === 'cart') ? 'text-white' : 'text-gray-500'; ?> group-hover:text-white transition">Cart</h1>
            </a>
