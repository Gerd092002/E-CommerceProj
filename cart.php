...
$isEmbedded = basename($_SERVER['PHP_SELF']) !== basename(__FILE__);
// Send users back to the best shopping surface for the current context.
$backUrl = 'index.php#products';
?>
<?php if (!$isEmbedded): ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-8">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <a href="<?php echo $backUrl; ?>" class="inline-flex items-center justify-center gap-2 bg-purple-600 text-white px-5 py-3 rounded-xl font-semibold hover:bg-purple-700 transition">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="cart-item-card bg-gray-50 rounded-xl p-4 border border-gray-200">
                                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                                        <div class="bg-white rounded-lg border border-gray-300 w-20 h-20 overflow-hidden flex items-center justify-center flex-shrink-0">
