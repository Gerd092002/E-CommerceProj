...
$pstmt = $conn->prepare("SELECT o.order_id,o.product_id,o.quantity,o.price,o.status,o.created_at,p.product_name FROM tbl_orders o LEFT JOIN tbl_products p ON o.product_id = p.product_id WHERE o.$user_col = ? AND o.status = 'purchased' ORDER BY o.created_at DESC");
...
$cstmt = $conn->prepare("SELECT o.order_id,o.product_id,o.quantity,o.price,o.status,o.created_at,p.product_name FROM tbl_orders o LEFT JOIN tbl_products p ON o.product_id = p.product_id WHERE o.$user_col = ? AND o.status = 'active' ORDER BY o.created_at DESC");
                        ...
                        <div class="grid grid-cols-1 gap-3">
                            ...
                            <div class="flex justify-between items-center p-3 bg-white rounded-lg border">
                                <div>
                                    ...
                                    <div class="text-xs text-gray-500">Added: <?php echo htmlspecialchars($item['created_at']); ?></div>
                                </div>
