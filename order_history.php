...
$pstmt = $conn->prepare("SELECT o.order_id,o.product_id,o.quantity,p.price,o.status,o.added_at,p.product_name FROM tbl_orders o LEFT JOIN tbl_products p ON o.product_id = p.product_id WHERE o.$user_col = ? AND o.status = 'purchased' ORDER BY o.added_at DESC");
...
$cstmt = $conn->prepare("SELECT o.order_id,o.product_id,o.quantity,p.price,o.status,o.added_at,p.product_name FROM tbl_orders o LEFT JOIN tbl_products p ON o.product_id = p.product_id WHERE o.$user_col = ? AND o.status = 'active' ORDER BY o.added_at DESC");
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6 mt-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="cart.php" class="inline-flex items-center gap-2 px-4 py-2 border border-purple-200 text-purple-600 rounded-lg hover:bg-purple-50">Cart</a>
                <a href="index.php#products" class="inline-flex items-center gap-2 px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700">Continue Shopping</a>
            </div>
        </div>
